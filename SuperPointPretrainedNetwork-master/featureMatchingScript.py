...
if __name__ == '__main__':
    ...
    frame_width = opt.W  # or the width of your frames
    frame_height = opt.H  # or the height of your frames
    fps = 30  # replace with the FPS of your input video

    output_video_path_extra = 'output_video_extra.mp4'
    output_video_path_primary = 'output_video_primary.mp4'

    # Initialize VideoWriter objects
    fourcc = cv2.VideoWriter_fourcc(*'mp4v')
    fps = 30  # Adjust as needed
    frame_width, frame_height = 1280, 720  # Adjust to your frame size
    out_video_extra = cv2.VideoWriter(output_video_path_extra, fourcc, fps, (frame_width, frame_height))
    out_video_primary = cv2.VideoWriter(output_video_path_primary, fourcc, fps, (frame_width, frame_height))

    print('==> Loading pre-trained network.')
    # This class runs the SuperPoint network and processes its outputs.
    fe = SuperPointFrontend(weights_path="SuperPointPretrainedNetwork-master/superpoint_v1.pth",
    ...
    while True:
        ...
        out_video_extra.write(out)  # Writing the combined frame with all information
        out_video_primary.write(out1)  # Writing only the primary output frame
